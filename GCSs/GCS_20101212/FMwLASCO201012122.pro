PRO FMwLASCO201012122
@gcs_config
;To load images from CORs A&B plus LASCO and call rtsccguicloud with forward model from Thernisien et al. (2009)

SAVE_FILE=GCSD_PATH+'/GCS_20101212/2.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/soho/lasco/level_1/c2'
;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/seq/cor1/20101212/preped/20101212_054500_0B4c1A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/seq/cor1/20101212/preped/20101212_053500_0B4c1A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/seq/cor1/20101212/preped/20101212_054000_0B4c1B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/seq/cor1/20101212/preped/20101212_053000_0B4c1B.fts', hdreventpb)
...
lasco1=readfits(lascopath+'/20101212/25354383.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20101212/25354382.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
