...
oaia0=sdopath+'/aia/L1/193/20101212/preped/AIA'+strjoin(DATE0)+'_'+strjoin(TIME0)+'_0193.fits'
oaia =sdopath+'/aia/L1/193/20101212/preped/AIA'+strjoin(DATE)+'_'+strjoin(TIME)+'_0193.fits'
...
;scales images
euvia=euvia>(mean(euvia)+RNG[0]*stddev(euvia)) <(mean(euvia)+RNG[1]*stddev(euvia))
euvib=euvib>(mean(euvib)+RNG[2]*stddev(euvib)) <(mean(euvib)+RNG[3]*stddev(euvib))
aia=aia>(mean(aia)+RNG[4]*stddev(aia)) <(mean(aia)+RNG[5]*stddev(aia))
