...
peuvib =secchipath+'/b/img/euvi/'+SDATE+'/preped/'+SDATE+'_'+'153030'+'_14euB.fts'
...
if ~file_test(peuvib) then begin 
  bla =secchipath+'/b/img/euvi/'+SDATE+'/'+SDATE+'_'+'153030'+'_n4euB.fts' 
