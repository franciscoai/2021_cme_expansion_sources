...
SAVE_FILE=GCSD_PATH+'/GCS_20110215/4.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/archive/soho/private/data/processed/lasco/level_1/110215/c2'
;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/img/cor2/20110215/level1/20110215_033900_14c2A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/img/cor2/20110215/level1/20110215_032400_14c2A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/img/cor2/20110215/level1/20110215_033900_14c2B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/img/cor2/20110215/level1/20110215_032400_14c2B.fts', hdreventpb)
...
a=sigrange(rebin(ma*sigrange(ima)-ma*sigrange(imaprev),512,512),MISSING=0) ;better for COR2
b=sigrange(rebin(mb*sigrange(imb)-mb*sigrange(imbprev),512,512),MISSING=0) ;better for COR2
;opens LASCO of interest and background
lasco1=readfits(lascopath+'/25361986.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/25361985.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
...
;EUVIs
imeuvib=sccreadfits(secchipath+'/b/img/euvi/195/20110215/preped/20110215_020030_14euB.fts', heuvib)
imeuvia=sccreadfits(secchipath+'/a/img/euvi/195/20110215/preped/20110215_020030_14euA.fts', heuvia)
;This one replaces one of the EUVIs for SDO AIA
;imeuvib=sccreadfits(DATA_PATH+'/sdo/aia/L1/193/20110215/preped/-', heuvib)
