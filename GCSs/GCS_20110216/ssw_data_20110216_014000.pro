...
;download
 DATES=['2011/02/15','2011/02/15']; no data available 
...
;download
 DATES=['2011/02/16','2011/02/16']
 TIMES=['14:00:00','16:00:00']
 TIMER=1.*1100  ; Time resolution [s]
 WAVE='193'  ; Wavelenght [nm]
...
;download
 DATES=['2011/02/16','2011/02/16']
 TIMES=['14:30:00','23:00:00']
 TIMER=1.*4800.   ; Time resolution [s]
