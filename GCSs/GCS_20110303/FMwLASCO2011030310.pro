PRO FMwLASCO2011030310
;Path to the save file where the GUI parameters will be saved/loaded
SAVE_FILE=GCSD_PATH+'/GCS_20110303/10.sav'

@gcs_config
;To load images from CORs A&B plus LASCO and call rtsccguicloud with forward model from Thernisien et al. (2009)
SAVE_FILE=GCSD_PATH+'/GCS_20101212/m1.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/soho/lasco/level_1/c2'
;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/img/cor2/20110303/level1/20110303_095400_04c2A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/img/cor2/20110303/level1/20110303_093900_04c2A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/img/cor2/20110303/level1/20110303_095400_04c2B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/img/cor2/20110303/level1/20110303_093900_04c2B.fts', hdreventpb)
...
lasco1=readfits(lascopath+'/20110303/25363811.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20110303/25363810.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
...
lasco= lasco>(-0.1e-10)<0.3e-10
;lasco= lasco>(-0.83e-9) <7.5e-10
;EUVIs
imeuvib=sccreadfits(secchipath+'/b/img/euvi/20110303/preped/20110302_234530_14euB.fts', heuvib)
imeuvia=sccreadfits(secchipath+'/a/img/euvi/20110303/preped/20110302_234530_14euA.fts', heuvia)
;This one replaces one of the EUVIs for SDO AIA
;imeuvib=sccreadfits(DATA_PATH+'/sdo/aia/L1/193/20110303/preped/AIA20110302_234407_0193.fits', heuvib)
