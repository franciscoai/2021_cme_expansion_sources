PRO FMwLASCO201104272
@gcs_config
;To load images from CORs A&B plus LASCO and call rtsccguicloud with forward model from Thernisien et al. (2009)
SAVE_FILE=GCSD_PATH+'/GCS_20110427/2.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/soho/lasco/level_1/c2'
;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/seq/cor1/20110427/preped/20110427_081000_0B4c1A.ft', hdreventa)
imaprev=sccreadfits(secchipath+'/a/seq/cor1/20110427/preped/20110427_080000_0B4c1A.ft',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/seq/cor1/20110427/preped/20110427_081000_0B4c1B.ft', hdreventb)
imbprev=sccreadfits(secchipath+'/b/seq/cor1/20110427/preped/20110427_080000_0B4c1B.ft', hdreventpb)
...
lasco1=readfits(lascopath+'/20110427/25370121.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20110427/25370120.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
...
;EUVIs
imeuvib=sccreadfits(secchipath+'/b/img/euvi/20110427/preped/20110427_074530_14euB.fts', heuvib)
imeuvia=sccreadfits(secchipath+'/a/img/euvi/20110427/preped/20110427_074530_14euA.fts', heuvia)
;This one replaces one of the EUVIs for SDO AIA
;imeuvib=sccreadfits(DATA_PATH+'/sdo/aia/L1/193/20110427/preped/-', heuvib)
