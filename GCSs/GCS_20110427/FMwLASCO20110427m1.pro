...
pro FMwLASCO20110427m1

@gcs_config
;Differential image scaling [SECCHIA,SECCHIA, SECCHIB,SECCHIB, AIA, AIA]
RNG=1.*[-1,1,-1,1,-0.1,0.1]

;Global Paths
SAVE_FILE=GCSD_PATH+'/GCS_20110427/m1.sav'
...
rtsccguicloud, euvia, euvib, euviahdr, euvibhdr, hdrlasco=aiahdr, sgui=sgui, sparaminit=sgui
