...
PRO FMwLASCO201106051
@gcs_config
;To load images from CORs A&B plus LASCO and call rtsccguicloud with forward model from Thernisien et al. (2009)

;Global Paths
SAVE_FILE=GCSD_PATH+'/GCS_20110605/1.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/soho/lasco/level_1/c2'

;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/seq/cor1/20110605/preped/20110605_051000_0B4c1A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/seq/cor1/20110605/preped/20110605_050000_0B4c1A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/seq/cor1/20110605/preped/20110605_051000_0B4c1B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/seq/cor1/20110605/preped/20110605_050000_0B4c1B.fts', hdreventpb)
...
lasco1=readfits(lascopath+'/20110605/25374830.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20110605/25374829.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
...
lasco= lasco>(-2.e-10)<2.e-10
;lasco= lasco>(-0.83e-9) <7.5e-10
;EUVIs
imeuvib=sccreadfits(secchipath+'/b/img/euvi/20110605/preped/20110605_054530_14euB.fts', heuvib)
;imeuvia=sccreadfits(secchipath+'/a/img/euvi/20110605/preped/20110605_061530_14euA.fts', heuvia)
;This one replaces one of the EUVIs for SDO AIA
imeuvia=sccreadfits(DATA_PATH+'/sdo/aia/L1/193/20110605/preped/AIA20110605_053907_0193.fits', heuvia)
