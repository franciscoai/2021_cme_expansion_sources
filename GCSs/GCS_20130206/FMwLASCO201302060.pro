...
;Global Paths
SAVE_FILE=GCSD_PATH+'/GCS_20130206/0.sav'
...
peuvib0=secchipath+'/b/img/euvi/'+SDATE0+'/preped/'+SDATE0+'_'+'001530'+'_14euB.fts'
peuvib =secchipath+'/b/img/euvi/'+SDATE+'/preped/'+SDATE+'_'+'003030'+'_14euB.fts'
if ~file_test(peuvib0) then begin 
  bla=secchipath+'/b/img/euvi/'+SDATE0+'/'+SDATE0+'_'+'001530'+'_n4euB.fts'
...
if ~file_test(peuvib) then begin 
  bla =secchipath+'/b/img/euvi/'+SDATE+'/'+SDATE+'_'+'003030'+'_n4euB.fts' 
