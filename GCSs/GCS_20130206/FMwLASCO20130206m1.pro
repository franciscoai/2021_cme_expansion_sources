...
;Global Paths
SAVE_FILE=GCSD_PATH+'/GCS_20130206/m1.sav'
...
peuvib =secchipath+'/b/img/euvi/'+SDATE+'/preped/'+SDATE+'_'+'001530'+'_14euB.fts'
...
if ~file_test(peuvib) then begin 
  bla =secchipath+'/b/img/euvi/'+SDATE+'/'+SDATE+'_'+'001530'+'_n4euB.fts' 
