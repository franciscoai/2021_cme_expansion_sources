...
;Global Paths
SAVE_FILE=GCSD_PATH+'/GCS_20130403/m1.sav'
...
if PLAY_MOVIE[0] then begin
 euvia_mov=DATA_PATH+'/stereo/secchi/L0/a/img/euvi/'+SDATE0+'/preped/'+SDATE0+'_EUVIA195_direct.mvi'
 scc_playmovie, euvia_mov
endif
if PLAY_MOVIE[1] then begin
 euvia_mov=DATA_PATH+'/stereo/secchi/L0/b/img/euvi/'+SDATE0+'/preped/'+SDATE0+'_EUVIB195_direct.mvi'
 scc_playmovie, euvia_mov
endif
