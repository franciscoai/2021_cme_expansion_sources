...
;SECCHI A
ima=sccreadfits(secchipath+'/a/seq/cor1/20130424(2)/preped/20130424_193000_0B4c1A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/seq/cor1/20130424(2)/preped/20130424_192000_0B4c1A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/seq/cor1/20130424(2)/preped/20130424_193500_0B4c1B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/seq/cor1/20130424(2)/preped/20130424_192500_0B4c1B.fts', hdreventpb)
...
lasco1=readfits(lascopath+'/20130424(2)/25456721.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20130424(2)/25456720.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
...
;EUVIs
;imeuvib=sccreadfits(secchipath+'/b/img/euvi/20130424(2)/preped/', heuvib)
imeuvia=sccreadfits(secchipath+'/a/img/euvi/20130424(2)/preped/20130424_141530_14euA.fts', heuvia)
;This one replaces one of the EUVIs for SDO AIA
imeuvib=sccreadfits(DATA_PATH+'/sdo/aia/L1/193/20130424(2)/preped/AIA20130424_111506_0193.fits', heuvib)
