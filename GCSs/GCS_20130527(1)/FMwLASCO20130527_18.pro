PRO FMwLASCO20130527_18
@gcs_config
;To load images from CORs A&B plus LASCO and call rtsccguicloud with forward model from Thernisien et al. (2009)
SAVE_FILE=GCSD_PATH+'/GCS_20130527(1)/8.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/soho/lasco/level_1/c2'
;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/img/cor2/20130527(1)/level1/20130527_083900_04c2A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/img/cor2/20130527(1)/level1/20130527_082400_04c2A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/img/cor2/20130527(1)/level1/20130527_083900_04c2B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/img/cor2/20130527(1)/level1/20130527_082400_04c2B.fts', hdreventpb)
...
lasco1=readfits(lascopath+'/20130527(1)/25460732.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20130527(1)/25460731.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
