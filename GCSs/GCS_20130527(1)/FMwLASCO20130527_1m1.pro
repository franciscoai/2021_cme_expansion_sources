...
;Global Paths
SAVE_FILE=GCSD_PATH+'/GCS_20130527(1)/m1.sav'
...
if PLAY_MOVIE[0] then begin
 euvia_mov=DATA_PATH+'/stereo/secchi/L0/a/img/euvi/'+SDATEDIR+'/preped/'+'20130527'+'_EUVIA195_rdiff.mvi'
 scc_playmovie, euvia_mov
endif
if PLAY_MOVIE[1] then begin
 euvia_mov=DATA_PATH+'/stereo/secchi/L0/b/img/euvi/'+SDATEDIR+'/preped/'+'20130527'+'_EUVIB195_rdiff.mvi'
 scc_playmovie, euvia_mov
endif
if PLAY_MOVIE[2] then begin
 euvia_mov=DATA_PATH+'/sdo/aia/L1/193/'+SDATEDIR+'/preped/'+'20130527'+'_AIA193_rdiff.mvi'
 scc_playmovie, euvia_mov
endif
