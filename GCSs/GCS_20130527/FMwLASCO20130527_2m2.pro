...
;Global Paths
SAVE_FILE=GCSD_PATH+'/GCS_20130527(2)/m2.sav'
...
if PLAY_MOVIE[0] then begin
 euvia_mov=DATA_PATH+'/stereo/secchi/L0/a/img/euvi/'+SDATE0+'(2)/preped/'+SDATE0+'_EUVIA195_rdiff.mvi'
 scc_playmovie, euvia_mov
endif
if PLAY_MOVIE[1] then begin
 euvia_mov=DATA_PATH+'/stereo/secchi/L0/b/img/euvi/'+SDATE0+'(2)/preped/'+SDATE0+'_EUVIB195_rdiff.mvi'
 scc_playmovie, euvia_mov
endif
if PLAY_MOVIE[2] then begin
 euvia_mov=DATA_PATH+'/sdo/aia/L1/193/'+SDATE0+'(2)/preped/'+SDATE0+'_AIA193_rdiff.mvi'
 scc_playmovie, euvia_mov
endif
...
peuvia0=secchipath+'/a/img/euvi/'+SDATE0+'(2)/preped/'+SDATE0+'_'+STIME0+'_14euA.fts'
peuvia =secchipath+'/a/img/euvi/'+SDATE+'(2)/preped/'+SDATE+'_'+STIME+'_14euA.fts'
...
peuvib0=secchipath+'/b/img/euvi/'+SDATE0+'(2)/preped/'+SDATE0+'_'+STIME0+'_14euB.fts'
peuvib =secchipath+'/b/img/euvi/'+SDATE+'(2)/preped/'+SDATE+'_'+STIME+'_14euB.fts'
...
oaia0=sdopath+'/aia/L1/193/'+strjoin(DATE0)+'(2)/preped/AIA'+strjoin(DATE0)+'_'+strjoin(TIME0)+'_0193.fits'
oaia =sdopath+'/aia/L1/193/'+strjoin(DATE)+'(2)/preped/AIA'+strjoin(DATE)+'_'+strjoin(TIME)+'_0193.fits'
