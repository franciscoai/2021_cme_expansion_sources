...
if do_aia then begin
 ODIR=DATA_PATH+'/sdo/aia/L1/193/20130531' 
 bus=vso_search('2013/05/31 06:00:00',' 2013/05/31 07:00:00', source='SDO', $
 instr='AIA', wave='193', sample=60.*10) ;Gets metadate from VSO
