PRO FMwLASCO20130531_23
@gcs_config
;To load images from CORs A&B plus LASCO and call rtsccguicloud with forward model from Thernisien et al. (2009)
SAVE_FILE=GCSD_PATH+'/GCS_20130531(2)/3.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/soho/lasco/level_1/c2'
;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/seq/cor1/20130531(2)/preped/20130531_182000_0B4c1A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/seq/cor1/20130531(2)/preped/20130531_181000_0B4c1A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/seq/cor1/20130531(2)/preped/20130531_182000_0B4c1B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/seq/cor1/20130531(2)/preped/20130531_181000_0B4c1B.fts', hdreventpb)
...
lasco1=readfits(lascopath+'/20130531(2)/25461263.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20130531(2)/25461262.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
...
;EUVIs
;imeuvib=sccreadfits(secchipath+'/b/img/euvi/20130531(2)/preped/20130531_171530_14euB.fts', heuvib)
imeuvia=sccreadfits(secchipath+'/a/img/euvi/20130531(2)/preped/20130531_171530_14euA.fts', heuvia)
;This one replaces one of the EUVIs for SDO AIA
imeuvib=sccreadfits(DATA_PATH+'/sdo/aia/L1/193/20130531(2)/preped/AIA20130531_203007_0193.fits', heuvib)
