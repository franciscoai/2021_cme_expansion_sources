...
SAVE_FILE=GCSD_PATH+'/GCS_20130608/3.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/soho/lasco/level_1/c2'
;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/seq/cor1/20130608/preped/20130607_235000_0B4c1A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/seq/cor1/20130608/preped/20130607_234000_0B4c1A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/seq/cor1/20130608/preped/20130607_235000_0B4c1B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/seq/cor1/20130608/preped/20130607_234000_0B4c1B.fts', hdreventpb)
...
lasco1=readfits(lascopath+'/20130608/25462153.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20130608/25462152.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
...
lasco= lasco>(-1.e-10)<1.e-10
;lasco= lasco>(-0.83e-9) <7.5e-10
;EUVIs
;;;imeuvib=sccreadfits(secchipath+'/b/img/euvi/20130608/preped/20130607_223030_14euB.fts', heuvib)
;;imeuvia=sccreadfits(secchipath+'/a/img/euvi/20130608/preped/20130607_223030_14euA.fts', heuvia)
;This one replaces one of the EUVIs for SDO AIA
;;imeuvib=sccreadfits(DATA_PATH+'/sdo/aia/L1/193/20130608/preped/AIA20130607_223006_0193.fits', heuvib)
...
rtsccguicloud, a, b, hdreventa, hdreventb, imlasco=lasco, hdrlasco=lascohdr, sgui=sgui, sparaminit=sgui ;, imeuvia=imea, hdreuvia=heuvia, imeuvib=imeb, hdreuvib=heuvib
