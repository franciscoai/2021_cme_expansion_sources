PRO FMwLASCO201306179
@gcs_config
;To load images from CORs A&B plus LASCO and call rtsccguicloud with forward model from Thernisien et al. (2009)
SAVE_FILE=GCSD_PATH+'/GCS_20130617/9.sav'
secchipath=DATA_PATH+'/stereo/secchi/L0'
lascopath=DATA_PATH+'/soho/lasco/level_1/c2'
;opens images of interest and backgrounds
;SECCHI A
ima=sccreadfits(secchipath+'/a/seq/cor1/20130617/preped/20130617_195400_04c2A.fts', hdreventa)
imaprev=sccreadfits(secchipath+'/a/seq/cor1/20130617/preped/20130617_193900_04c2A.fts',hdreventpa)
;SECCHI B
imb=sccreadfits(secchipath+'/b/seq/cor1/20130617/preped/20130617_195400_04c2B.fts', hdreventb)
imbprev=sccreadfits(secchipath+'/b/seq/cor1/20130617/preped/20130617_193900_04c2B.fts', hdreventpb)
...
lasco1=readfits(lascopath+'/20130617/25463359.fts', lasco1hdr);+'/C3/L0/20130328/32334111.fts', lasco1hdr)
lasco0=readfits(lascopath+'/20130617/25463360.fts', lasco0hdr);+'/C3/L0/20130328/32334110.fts', lasco0hdr)
